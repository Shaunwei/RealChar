        ...
        ?.map(line => {
          if (
            ...
            return (
              ...
              >
                <p className='w-fit max-w-[450px] py-2 px-5 font-light flex-none rounded-3xl md:mr-3 rounded-bl-none bg-real-navy/20'>
                  {line.content}
                </p>
                <div>
                  <Button
            ...
            return (
              <div key={line.timestamp} className='self-end'>
                <p className='w-fit max-w-[450px] py-2 px-5 font-light flex-none rounded-3xl rounded-br-none bg-real-navy/50'>
                  {line.content}
                </p>
              </div>
            );
